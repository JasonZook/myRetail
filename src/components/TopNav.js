...
export default class Header extends Component {
  ...
  render() {
    ...
    return (
      <nav className="navbar navbar-expand-lg myretail-green-bg shadow-sm border-bottom-gray">
          ...
          <div className="collapse navbar-collapse ml-5" id="navbarsHeader">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item mx-4">
                <a className="md-gray-text text-bold font-point-nine" href="#">Home Goods</a>
              </li>
              <li className="nav-item mx-4">
                <a className="md-gray-text text-bold font-point-nine" href="#">Apparel</a>
              </li>
              <li className="nav-item mx-4">
                <a className="md-gray-text text-bold font-point-nine" href="#">Kids</a>
              </li>
              <li className="nav-item mx-4">
                <a className="md-gray-text text-bold font-point-nine" href="#">Organics</a>
              </li>
            </ul>
